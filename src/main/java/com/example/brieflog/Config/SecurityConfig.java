package com.example.brieflog.Config;

import com.example.brieflog.Security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .httpBasic(httpBasic -> httpBasic.disable()) // 기본 인증(브라우저 팝업) 비활성화
